...
import hikari,psutil,lightbulb,random,pickle,time,os,json,asyncio
...
async def vote(ctx):
    ...
    if user_id in bank:
        ...
        bank[user_id] = {'balance': reward, 'last_used': now, "banner": "0"}
